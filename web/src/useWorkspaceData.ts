...
export function useWorkspaceData() {
  ...
  return {
    ...
    createXrayProfile: (input: Parameters<typeof createXrayProfile>[0]) => runMutation(() => createXrayProfile(input)),
    deleteXrayProfile: (id: string) => runMutation(() => deleteXrayProfile(id)),
    applyXrayProfile: (id: string, input: Parameters<typeof applyXrayProfile>[1]) =>
      runMutation(() => applyXrayProfile(id, input)),
    ...
    createOpsResource: (input: Parameters<typeof createOpsResource>[0]) => runMutation(() => createOpsResource(input)),
    deleteOpsResource: (id: string) => runMutation(() => deleteOpsResource(id)),
    executeOpsResource: (id: string, input: Parameters<typeof executeOpsResource>[1]) =>
      runMutation(() => executeOpsResource(id, input)),
